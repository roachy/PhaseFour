...
SWEP.Instructions = "Primary Fire: Dice.";
SWEP.Purpose = "This awesome Japanese katana can dice up anything.";
SWEP.Contact = "";
...
function SWEP:PrimaryAttack()
	...
	if (SERVER) then
		if (PhaseFour.augments:Has(self.Owner, AUG_RAPIDMELEE)) then
			weaponDelay = weaponDelay / 2;
		end;
	elseif (PhaseFour.augments:Has(AUG_RAPIDMELEE)) then
		weaponDelay = weaponDelay / 2;
	end;
