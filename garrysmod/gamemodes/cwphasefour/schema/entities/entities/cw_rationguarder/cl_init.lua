...
function ENT:HUDPaintTargetID(x, y, alpha)
	...
	y = Clockwork.kernel:DrawInfo("Ration Guarder", x, y, colorTargetID, alpha);
	...
	y = Clockwork.kernel:DrawInfo("This is guarding "..guarding.." generator(s).", x, y, colorWhite, alpha);
end;
