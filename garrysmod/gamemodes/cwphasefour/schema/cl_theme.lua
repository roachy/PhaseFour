...
function THEME:CreateFonts()
	surface.CreateFont("lab_Large3D2D", {
	...
	surface.CreateFont("lab_IntroTextSmall", {
	...
	surface.CreateFont("lab_IntroTextTiny", {
	...
	surface.CreateFont("lab_CinematicText", {
	...
	surface.CreateFont("lab_IntroTextBig", {
	...
	surface.CreateFont("lab_TargetIDText", {
		size = Clockwork.kernel:FontScreenScale(8),
		weight = 600, 
		antialias = true,
		font = "Dirty Ego"
	...
	surface.CreateFont("lab_SmallBarText", {
	...
	surface.CreateFont("lab_MenuTextHuge", {
	...
	surface.CreateFont("lab_MenuTextBig", {
	...
	surface.CreateFont("lab_PlayerInfoText", {
		size = Clockwork.kernel:FontScreenScale(8),
		weight = 600, 
		antialias = true,
		font = "Dirty Ego"
	...
	surface.CreateFont("lab_MainText", {
